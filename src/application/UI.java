...
public class UI {
	...
	public static PosicaoXadrez lerPosicaoXadrez(Scanner sc) {
		try {
			...
			throw new InputMismatchException("Erro ao ler a posição de Xadrez. Os valores válidos vão de a1 até h8.");

		}
	}

	public static void imprimirPartida(PartidaDeXadrez partidaDeXadrez, List<PecaDeXadrez> capturadas) {
		imprimirTabuleiro(partidaDeXadrez.obterPecas());
		System.out.println();
		imprimirPecasCapturas(capturadas);
		System.out.println();
		System.out.println("Turno: " + partidaDeXadrez.obterTurno());
		System.out.println();
		System.out.println("Aguardando jogador: " + partidaDeXadrez.obterJogadorAtual());
	}
	...
	private static void imprimirPecasCapturas(List<PecaDeXadrez> capturadas) {
